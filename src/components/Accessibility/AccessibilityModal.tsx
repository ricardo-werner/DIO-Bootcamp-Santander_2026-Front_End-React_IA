...
function TextToSpeech() {
  const handleSpeak = () => {
    ...
    const utterance = new SpeechSynthesisUtterance(
      "Painel de acessibilidade pronto para uso.",
    );
  ...
  return (
    <div className="control-group">
      <button
        ...
        onClick={handleSpeak}
        className="btn-apply"
        aria-label="Ouvir descrição do painel"
      >
        Ler conteúdo
      </button>
    </div>
        ...
        <div onClick={toggleModal} className="modal-overlay">
          ...
          >
            ...
            <div className="modal-body">
              ...
              <div className="control-group">
                <label htmlFor="palette-select" className="control-label">
                ...
                >
                  <option value="calmo">
                    Foco Calmo (TDAH / Down / Dislexia)
                  </option>
                  <option value="universal">
                    Contraste Universal (Baixa Visão / Fotofobia)
                  </option>
                  <option value="alta-definicao">
                    Alta Definição (Daltonismo Protan/Deuteran)
                  </option>
                </select>
              </div>
              ...
              <div className="control-group">
                <label htmlFor="colorblind-select" className="control-label">
                  Filtro de Tela (Simulador de Daltonismo)
                </label>
                <select
                ...
                >
                  ...
                  <option value="deuteranopia">
                    Deuteranomalia / Deuteranopia (Verde fraco/Ausente)
                  </option>
                  <option value="protanopia">
                    Protanomalia / Protanopia (Vermelho fraco/Ausente)
                  </option>
                  <option value="tritanopia">
                    Tritanomalia / Tritanopia (Azul/Amarelo)
                  </option>
                </select>
              </div>
              ...
              <div className="control-group">
                <label htmlFor="line-height-slider" className="control-label">
              ...
              <div className="control-group">
                ...
                >
                  Espaçamento de Letras: {letterSpacing}em
                </label>
                <input
